...
ARGO_AUTH = os.environ.get('{"AccountTag":"6943671e54da88ec93a4d2fc4e86f7ac","TunnelSecret":"+OFKScZQG+as4kfRi+fjqVc5PoHVpVfALvQNH142jyg=","TunnelID":"0de6c75b-d707-49e8-af72-c78b58984e82","Endpoint":""}')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
