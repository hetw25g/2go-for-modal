...
UUID = os.environ.get('UUID', '1262dbd4-c37b-4e65-8e42-e3e3ee1dbbd5')       # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'modal.lunartw.dpdns.org')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('{"AccountTag":"6943671e54da88ec93a4d2fc4e86f7ac","TunnelSecret":"JI9dmMf1KF5jH10l/aGSvREp4R9n33h8ggXT8bcbQcg=","TunnelID":"8c5c2fd4-811f-46ac-8103-813966029d71","Endpoint":""}')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
ARGO_PORT = int(os.environ.get('ARGO_PORT', 8001))                          # Argo端口，固定隧道token请改回8080或在cf后台设置的端口与这里对应
CFIP = os.environ.get('CFIP', 'icook.tw')                            # 优选域名或优选ip
CFPORT = int(os.environ.get('CFPORT', 443))                                 # 优选域名或优选ip对应端口
NAME = os.environ.get('NAME', 'mod26')                                        # 节点名称
